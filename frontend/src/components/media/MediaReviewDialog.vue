...
<!--
  ...
  Theme Atlas v2 của chat (Lucide icon, action #981820 — KHÔNG emoji).
-->
<template>
...
.mr-box {
  ...
  --soft:#f1f4f9; --action:#981820; --action-soft:#F7E9EA; --coral:#aa2d00;
...
/* Nút Gửi: màu hành động chuẩn HS (action #981820) — nổi + đúng nhận diện theme. */
