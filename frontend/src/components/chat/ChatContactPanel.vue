  ...
  <aside class="info-panel">
    ...
    <div v-if="mainTab === 'ai'" class="main-tab-body">
      <div class="main-tab-placeholder">
        ...
        <!-- 20/08: chữ cũ của bên bán phần mềm là "Trợ lý AI Bất động sản … BĐS HS Holding"
             — sai hoàn toàn ngành hàng, nhân viên đọc vào sẽ tưởng bấm nhầm hệ thống. -->
        <h3>Trợ lý AI tư vấn</h3>
        <p>Hỏi đáp về sản phẩm, giá, ưu đãi và kịch bản chăm khách.</p>
        <div class="mtp-coming">🚧 Đang phát triển — kết nối kho tri thức sản phẩm AVE</div>
      </div>
    </div>
    ...
    <nav class="bottom-tabs" role="tablist" aria-label="Chuyển tab chính">
      ...
      <button
        ...
        title="AI — Trợ lý hỏi đáp sản phẩm"
        @click="mainTab = 'ai'"
      >
