...
.avatar-edit {
  ...
  background: var(--brand, #981820); color: #fff;
...
.role-admin { background: var(--brand-soft, #F7E9EA); color: var(--brand-700, #631015); }
...
.sc:hover { border-color: var(--brand, #981820); background: var(--brand-softer, #FCF5F5); }
.sc-ic {
